...
VERIFY2_API = environ.get('VERIFY2_API', "a5024669723a642ea824f28864dcadc4531d62223")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'powerlinkz.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '77ea37b60632c0c771334839818fec283992f7f3')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'True')), True)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/VoltDiscussions1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/VoltDiscussions2')
